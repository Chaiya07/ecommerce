<div class="sidebar">
    <div class="text-center text-white py-4 border-buttom">
        <i class="bi bi-speeddometer2 fs-1"></i>
        <h5 class="mt-2 mb-0">Admin Panel</h5>
    </div>
    <div class="mt-3">
        <a href="dashboard.php
        class="<?= $currenPage === 'dashboard.php' ? 'active' : '' ?>">
            <i class="bi bi-house-door-fill me-2"></i>Dashboard
        </a>
        <a href="manage_user.php"
        class="<?= $currenPage === 'manage_user.php' ? 'active' : '' ?>">
            <i class="bi bi-people-fill me-2"></i>จัดการสมาชิก
        </a>
        <a href="manage_products.php"
        class="<?= $currenPage === 'manage_products.php' ? 'active' : '' ?>">
            <i class="bi bi-box-seam me-2"></i>จัดการสินค้า
        </a>
        <a href="manage_orders.php"
        class="<?= $currenPage === 'manage_orders.php' ? 'active' : '' ?>">
            <i class="bi bi-receipt-cutoff me-2"></i>จัดการคำสั่งซื้อ
        </a>
        <a href="manage_coupons.php"
        class="<?= $currenPage === 'manage_coupons.php' ? 'active' : '' ?>">
            <i class="bi bi-ticket-perforated me-2"></i>จัดการคูปอง
        </a>
        <a href="reports.php"
        class="<?= $currenPage === 'reports.php' ? 'active' : '' ?>">
            <i class="bi bi-bar-chart-fill me-2"></i>รายงานยอดขาย
        </a>
        <a href="settings.php"
        class="<?= $currenPage === 'settings.php' ? 'active' : '' ?>">
